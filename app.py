...
with tab_liab:
    ...
    if st.session_state.liabilities:
        ...
        for l in st.session_state.liabilities:
            ...
            with st.expander(f"Amortization: **{l['name'] or 'Unnamed Loan'}** (Principal: {fmt_full(principal)} | Rate: {rate}%)", expandedI encountered an error doing what you asked. Could you try again?
